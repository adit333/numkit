/* Includes implementation of algortihm to find Convex hull.

Implemented both Graham's scan algorithm and Jarvis march algorithm.

Both Jarvis' March (O(n * h)) and   Graham's Scan (O(n log n)).
